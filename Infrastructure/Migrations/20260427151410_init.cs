        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverSefit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OvertimeSefite = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Payroll_Deductions", "[Deductions] >= 0");
                    table.CheckConstraint("CK_Payroll_GrossPay", "[GrossPay] >= 0");
                    table.CheckConstraint("CK_Payroll_OvertimeRate", "[OvertimeSefite] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Recruitments_Departments_DepartmentId1",
                        column: x => x.DepartmentId1,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Recruitments_Employees_HiringManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationInterview_ApplicationProcessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recruitments_DepartmentId1",
                table: "Recruitments",
                column: "DepartmentId1");

            migrationBuilder.CreateIndex(
                name: "IX_Recruitments_HiringManagerId",
                table: "Recruitments",
